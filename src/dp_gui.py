...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.player_time.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        ...
        self.button_repeat_track = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.button_repeat_track.sizePolicy().hasHeightForWidth())
        self.button_repeat_track.setSizePolicy(sizePolicy)
        self.button_repeat_track.setCursor(QtGui.QCursor(QtCore.Qt.OpenHandCursor))
        self.button_repeat_track.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.button_repeat_track.setCheckable(True)
        self.button_repeat_track.setAutoDefault(False)
        self.button_repeat_track.setDefault(False)
        self.button_repeat_track.setFlat(False)
        self.button_repeat_track.setObjectName("button_repeat_track")
        self.horizontalLayout_2.addWidget(self.button_repeat_track)
        ...
        self.files = QtWidgets.QListView(self.files_section)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.player_time.setText(_translate("MainWindow", "[  /  ]"))
        self.button_repeat_track.setText(_translate("MainWindow", "Repeat track"))
